...
| B       | 100      | 0.93%  | 1.97x    | **STABLE SUBMISSION CONFIGURATION**. Optimized structure to XOR(1,2). Safely handles Profile B limits. Result VALID. |
| A       | 60       | 0.60%  | 1.97x    | Final Validation on Profile A. Result VALID. |
| B       | 98       | 0.95%* | 1.97x    | *EXPERIMENTAL ONLY*. Pushed delay down to 98ms. Average is valid, but single-seed variances hit 1.07% misses. Result INVALID for strict grading. |
